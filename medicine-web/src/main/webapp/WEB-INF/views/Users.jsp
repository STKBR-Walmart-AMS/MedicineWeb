...
<html>
<head>
<title>Medicine Tasks Manager</title>
<style>
.username.ng-valid {
...
<body ng-app="myApp" class="ng-cloak">
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								...
								<div class="has-error" ng-show="myForm.$dirty">
									<span ng-show="myForm.email.$error.required">This is a required field</span> <span ng-show="myForm.email.$invalid">This field is invalid </span>
								</div>
							</div>
						</div>
					</div>
	...
	<script
		src="<c:url value='/resources/js/controller/userController.js' />"></script>
</body>
</html>